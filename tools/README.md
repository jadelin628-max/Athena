...
| `check_version.mjs` | 版本标记一致性七处（app.js VERSION+CHANGELOG / sw.js / index.html ?v= / package.json / tauri.conf.json / dist/app.js） | `node tools/check_version.mjs` |

（历史一次性脚本 `check_math3.py` 已删除——被 `check_data.mjs` 取代，且写死了本机旧路径。）
